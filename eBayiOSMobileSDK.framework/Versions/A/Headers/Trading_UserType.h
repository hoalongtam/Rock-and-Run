...
/**
 ...
 @ingroup Trading
*/
@interface Trading_UserType : NSObject <EbayNs_Bindable> {

@private
    NSNumber *aboutMePage;
    NSString *eiasToken;
    NSString *email;
    ...
    NSNumber *feedbackPrivate;
    NSString *feedbackRatingStar;
    NSNumber *idVerified;
    NSNumber *eBayGoodStanding;
    NSNumber *newUser;
    Trading_AddressType *registrationAddress;
    NSDate *registrationDate;
    NSString *site;
    NSString *status;
    NSString *userID;
    NSNumber *userIDChanged;
    NSDate *userIDLastChanged;
    NSString *vatStatus;
    Trading_BuyerType *buyerInfo;
    Trading_SellerType *sellerInfo;
    Trading_CharityAffiliationsType *charityAffiliations;
    NSString *payPalAccountLevel;
    NSString *payPalAccountType;
    NSString *payPalAccountStatus;
    NSMutableArray *userSubscription;
    NSNumber *siteVerified;
    NSMutableArray *skypeID;
    NSNumber *eBayWikiReadOnly;
    NSNumber *tuvLevel;
    NSString *vatid;
    NSNumber *motorsDealer;
    NSString *sellerPaymentMethod;
    Trading_BiddingSummaryType *biddingSummary;
    NSNumber *userAnonymized;
    NSNumber *uniqueNeutralFeedbackCount;
    NSNumber *enterpriseSeller;
    NSString *billingEmail;
    NSNumber *qualifiesForSelling;
    NSString *staticAlias;
...
/**
 ...
 if you and the other user are in a transactional relationship,
 within a certain time of transaction creation
...
/**
 ...
 with a user as a buyer or a seller in transactions. Each transaction can
...
/**
 ...
 desirability of dealing with that person as a Buyer or a Seller in auction
 transactions. Each auction transaction can result in one feedback entry for
...
/**
 ...
 Not returned if the user has no feedback. In GetSearchResults and
 GetCategoryListings, feedback information is only returned if
...
/**
 ...
 are private. In GetSearchResults and GetCategoryListings, feedback
...
/**
 ...
 (except for Phone) is only returned if you have a transactional relationship
...
/**
 ...
 <br><br>
 Note that when IncludeFeedback is true in
 a GetSearchResults request, the response contains the seller's User ID.
 Please note that a seller's UserID is not anonymized.
 <br><br>
...
/**
 ...
 authorized to list Live Auction items or opts to have items
 cross-promoted.
 <br><br>
