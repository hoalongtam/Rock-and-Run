...
*/
@interface FindingService_ListingInfo : NSObject <EbayNs_Bindable> {

@private
    NSNumber *bestOfferEnabled;
    NSNumber *buyItNowAvailable;
    FindingService_Amount *buyItNowPrice;
    FindingService_Amount *convertedBuyItNowPrice;
    NSDate *startTime;
    NSDate *endTime;
...
*/
@property (nonatomic, retain) FindingService_Amount *buyItNowPrice;
...
/**
 ...
 type : class FindingService_Amount
*/
@property (nonatomic, retain) FindingService_Amount *convertedBuyItNowPrice;
