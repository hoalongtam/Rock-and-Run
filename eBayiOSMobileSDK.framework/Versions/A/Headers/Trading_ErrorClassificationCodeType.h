...
*/
extern NSString *const Trading_ErrorClassificationCodeType_REQUEST_ERROR;
...
*/
extern NSString *const Trading_ErrorClassificationCodeType_SYSTEM_ERROR;
...
*/
extern NSString *const Trading_ErrorClassificationCodeType_CUSTOM_CODE;
