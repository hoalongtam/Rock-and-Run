...
@private
    ...
    NSString *pictureSet;
    Trading_Base64BinaryType *pictureData;
    NSString *pictureUploadPolicy;
    NSMutableArray *externalPictureURL;
    NSMutableArray *pictureWatermark;
    NSNumber *extensionInDays;
