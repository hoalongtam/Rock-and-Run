...
@class FindingService_PaginationInput;
@class SOACommon_Affiliate;
...
*/
@interface FindingService_BaseFindingServiceRequest : SOACommon_BaseServiceRequest {

@private
    FindingService_PaginationInput *paginationInput;
    NSString *buyerPostalCode;
    SOACommon_Affiliate *affiliate;
    NSString *sortOrder;
...
/**
 ...
 type : class FindingService_PaginationInput
*/
@property (nonatomic, retain) FindingService_PaginationInput *paginationInput;
...
/**
 ...
 type : class SOACommon_Affiliate
*/
@property (nonatomic, retain) SOACommon_Affiliate *affiliate;
...
/**
 ...
 type: string constant in FindingService_SortOrderType.h
*/
