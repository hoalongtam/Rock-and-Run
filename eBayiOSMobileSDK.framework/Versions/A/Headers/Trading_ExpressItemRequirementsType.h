...
/**
 ...
 @ingroup Trading
*/
@interface Trading_ExpressItemRequirementsType : NSObject <EbayNs_Bindable> {

@private
    NSNumber *sellerExpressEligible;
    NSNumber *expressOptOut;
    NSNumber *expressApproved;
    NSNumber *expressEligibleListingType;
    NSNumber *expressEnabledCategory;
    NSNumber *eligiblePayPalAccount;
    NSNumber *domesticShippingCost;
    NSNumber *eligibleReturnPolicy;
    NSNumber *picture;
    NSNumber *eligibleItemCondition;
    NSNumber *priceAboveMinimum;
    NSNumber *priceBelowMaximum;
    NSNumber *eligibleCheckout;
    NSNumber *noPreapprovedBidderList;
    NSNumber *noCharity;
    NSNumber *combinedShippingDiscount;
    NSNumber *shipFromEligibleCountry;
    NSNumber *payPalAccountAcceptsUnconfirmedAddress;
