...
*/
extern NSString *const SOACommon_ErrorCategory_SYSTEM;
...
*/
extern NSString *const SOACommon_ErrorCategory_APPLICATION;
...
*/
extern NSString *const SOACommon_ErrorCategory_REQUEST;
