...
/**
 ...
 @ingroup Trading
*/
@interface Trading_TimeZoneDetailsType : NSObject <EbayNs_Bindable> {

@private
    NSString *timeZoneID;
    NSString *standardLabel;
    NSString *standardOffset;
    NSString *daylightSavingsLabel;
    NSString *daylightSavingsOffset;
    NSNumber *daylightSavingsInEffect;
