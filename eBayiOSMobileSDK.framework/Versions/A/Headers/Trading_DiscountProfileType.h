...
/**
 ...
 @ingroup Trading
*/
@interface Trading_DiscountProfileType : NSObject <EbayNs_Bindable> {

@private
    NSString *discountProfileID;
    NSString *discountProfileName;
    Trading_AmountType *eachAdditionalAmount;
    Trading_AmountType *eachAdditionalAmountOff;
    NSNumber *eachAdditionalPercentOff;
    Trading_MeasureType *weightOff;
    NSString *mappedDiscountProfileID;
