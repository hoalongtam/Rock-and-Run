...
/**
 ...
 @ingroup Trading
*/
@interface Trading_ApiAccessRuleType : NSObject <EbayNs_Bindable> {

@private
    NSString *callName;
    NSNumber *countsTowardAggregate;
    NSNumber *dailyHardLimit;
    NSNumber *dailySoftLimit;
    NSNumber *dailyUsage;
    NSNumber *hourlyHardLimit;
    NSNumber *hourlySoftLimit;
    NSNumber *hourlyUsage;
    NSNumber *period;
    NSNumber *periodicHardLimit;
    NSNumber *periodicSoftLimit;
    NSNumber *periodicUsage;
    NSDate *periodicStartDate;
    NSDate *modTime;
    NSString *ruleCurrentStatus;
    NSString *ruleStatus;
