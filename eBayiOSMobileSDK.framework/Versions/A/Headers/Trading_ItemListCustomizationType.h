...
/**
 ...
 @ingroup Trading
*/
@interface Trading_ItemListCustomizationType : NSObject <EbayNs_Bindable> {
...
/**
 ...
 Filter to reduce the SoldList response based on whether the seller (or eBay) marked the applicable transaction as Paid and/or Shipped
 in My eBay.<br>
 <br>
 (Sellers can use CompleteSale or the eBay Web site UI to mark a 
 transaction as Paid or Shipped in My eBay. Sellers can also specify
 PaymentStatus in ReviseCheckoutStatus to mark a transaction as 
