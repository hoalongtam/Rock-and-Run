...
/**
 ...
 @ingroup Shopping
*/
@interface Shopping_ShippingDetailsType : NSObject <EbayNs_Bindable> {
...
@private
    ...
    Shopping_SalesTaxType *salesTax;
    NSString *shippingRateErrorMessage;
    NSMutableArray *shippingServiceOption;
    Shopping_TaxTableType *taxTable;
    Shopping_AmountType *internationalInsuranceCost;
    NSString *internationalInsuranceOption;
    Shopping_AmountType *codCost;
