...
/**
 ...
 @ingroup Trading
*/
@interface Trading_CalculatedShippingRateType : NSObject <EbayNs_Bindable> {
...
@private
    ...
    Trading_AmountType *packagingHandlingCosts;
    NSNumber *shippingIrregular;
    NSString *shippingPackage;
    Trading_MeasureType *weightMajor;
    Trading_MeasureType *weightMinor;
    Trading_AmountType *internationalPackagingHandlingCosts;
