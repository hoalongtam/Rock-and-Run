...
/**
 ...
 @ingroup Trading
*/
@interface Trading_ExternalProductIDType : NSObject <EbayNs_Bindable> {

@private
    NSString *value;
    NSNumber *returnSearchResultOnDuplicates;
    NSString *type;
    NSMutableArray *alternateValue;
...
/**
 ...
 type: string constant in Trading_ExternalProductCodeType.h
*/
