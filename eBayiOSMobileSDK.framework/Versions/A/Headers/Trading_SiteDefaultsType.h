...
/**
 ...
 @ingroup Trading
*/
@interface Trading_SiteDefaultsType : NSObject <EbayNs_Bindable> {
...
@private
    ...
    NSString *localListingDistancesRegular;
    NSString *localListingDistancesSpecialty;
    NSString *localListingDistancesNonSubscription;
    ...
    NSNumber *maxFlatShippingCostCBTExempt;
