...
/**
 ...
 @ingroup Trading
*/
@interface Trading_MyMessagesMessageType : NSObject <EbayNs_Bindable> {
...
/**
 ...
 The message body. Plain text. The API does not currently check the user email format
 preferences that can be specified in My Messages on the eBay.com Web site.
...
/**
 ...
 The title of the item listed by the user
