...
/**
 ...
 @ingroup Shopping
*/
@interface Shopping_ShippingServiceOptionType : NSObject <EbayNs_Bindable> {

@private
    Shopping_AmountType *shippingInsuranceCost;
    NSString *shippingServiceName;
    Shopping_AmountType *shippingServiceCost;
    Shopping_AmountType *shippingServiceAdditionalCost;
    NSNumber *shippingServicePriority;
    NSNumber *expeditedService;
    NSNumber *shippingTimeMin;
    NSNumber *shippingTimeMax;
    Shopping_AmountType *shippingSurcharge;
    NSMutableArray *shipsTo;
