...
/**
 ...
 @ingroup Shopping
*/
@interface Shopping_SimpleUserType : NSObject <EbayNs_Bindable> {
...
@private
    ...
    NSString *storeURL;
    NSString *storeName;
    NSString *sellerItemsURL;
    NSString *aboutMeURL;
    NSString *myWorldURL;
    NSString *myWorldSmallImage;
    NSString *myWorldLargeImage;
    NSString *reviewsAndGuidesURL;
    NSString *feedbackDetailsURL;
