...
@private
    ...
    NSNumber *buyingGuideCount;
    NSNumber *reviewerRank;
    NSNumber *totalHelpfulnessVotes;
    Shopping_ProductIDType *productID;
    NSString *reviewsAndGuidesURL;
    NSNumber *pageNumber;
    NSNumber *totalPages;
    Shopping_BuyingGuideDetailsType *buyingGuideDetails;
    Shopping_ReviewDetailsType *reviewDetails;
    NSNumber *positiveHelpfulnessVotes;
