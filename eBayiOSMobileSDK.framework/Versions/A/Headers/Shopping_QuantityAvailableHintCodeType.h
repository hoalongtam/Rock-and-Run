...
*/
extern NSString *const Shopping_QuantityAvailableHintCodeType_LIMITED;
...
*/
extern NSString *const Shopping_QuantityAvailableHintCodeType_MORE_THAN;
...
*/
extern NSString *const Shopping_QuantityAvailableHintCodeType_CUSTOM_CODE;
