...
/**
 ...
 @ingroup Trading
*/
@interface Trading_BiddingDetailsType : NSObject <EbayNs_Bindable> {

@private
    Trading_AmountType *convertedMaxBid;
    Trading_AmountType *maxBid;
    NSNumber *quantityBid;
    NSNumber *quantityWon;
    NSNumber *winning;
    NSNumber *bidAssistant;
