...
*/
extern NSString *const Shopping_ErrorClassificationCodeType_REQUEST_ERROR;
...
*/
extern NSString *const Shopping_ErrorClassificationCodeType_SYSTEM_ERROR;
...
*/
extern NSString *const Shopping_ErrorClassificationCodeType_CUSTOM_CODE;
