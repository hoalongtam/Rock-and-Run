...
/**
 ...
 @ingroup Trading
*/
@interface Trading_MyeBayFavoriteSearchType : NSObject <EbayNs_Bindable> {

@private
    NSString *searchName;
    NSString *searchQuery;
    NSString *queryKeywords;
    NSString *categoryID;
    NSString *itemSort;
    NSString *sortOrder;
    NSDate *endTimeFrom;
    ...
    NSString *postalCode;
    NSString *itemType;
    Trading_AmountType *priceMax;
    Trading_AmountType *priceMin;
    NSString *currency;
    NSNumber *bidCountMax;
    NSNumber *bidCountMin;
    NSMutableArray *searchFlag;
    NSString *paymentMethod;
    NSString *preferredLocation;
    NSMutableArray *sellerID;
    NSMutableArray *sellerIDExclude;
    NSString *itemsAvailableTo;
    NSString *itemsLocatedIn;
    NSString *sellerBusinessType;
    NSString *condition;
    NSNumber *quantity;
    NSString *quantityOperator;
